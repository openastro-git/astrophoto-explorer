...
def enrich_from_web(object_name: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        search_query = f"{object_name} nebula galaxy cluster astronomical object"
            ...
            try:
                ...
                if obj:
                    ...
                    info = {
                        ...
                        'constellation': obj.constellation if hasattr(obj, 'constellation') and obj.constellation else 'Unknown',
                    ...
                    try:
                        if hasattr(obj, 'rad_coords') and obj.rad_coords is not None:
                            ...
                            print(f"[ASTRO INFO] PyONGC coordinates for {normalized_name}: ra={info['ra']}, dec={info['dec']}")
                    except Exception as e:
