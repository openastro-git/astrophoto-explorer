...
def auto_stretch_channel(data, target_background=0.17, shadows_clipping=-2.8, qfloor=0.001):
    ...
    logger.debug(
        f"Stretch params - raw_median: {raw_median:.4f}, shadows: {shadows_clip:.4f}, "
...
def generate_preview_mtf(
    data, size=(800, 800), target_background=0.17, shadows_clipping=-2.8, contrast_boost=1.1, linked_channels=True
):
    """
