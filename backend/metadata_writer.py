...
def _read_png_chunks(file_path: str):
    ...
    with open(file_path, "rb") as f:
        ...
        while True:
            ...
            chunks.append({"type": chunk_type, "data": data, "crc": crc})
...
def _create_itxt_chunk(keyword: str, text: str) -> dict:
    ...
    return {"type": b"iTXt", "data": data, "crc": None}
...
def save_metadata_to_png(file_path: str, metadata: Dict[str, Any]) -> bool:
    ...
    try:
        ...
        comment_chunk = {"type": b"tEXt", "data": comment_data, "crc": None}
...
def read_metadata_from_png(file_path: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        ...
        # Find Comment chunk
        for i, chunk in enumerate(chunks):
            chunk["type"].decode("latin-1") if isinstance(chunk["type"], bytes) else chunk["type"]
...
def save_metadata_to_tiff(file_path: str, metadata: Dict[str, Any]) -> bool:
    ...
    try:
        ...
        if use_pil_fallback:
            print("[TIFF] Compressed TIFF detected, using PIL to read...")
